...
namespace PluralHost.Api.Data.Migrations
{
    ...
    [Migration("20260403205728_AddBucketFieldExclusions")]
    partial class AddBucketFieldExclusions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PluralHost.Api.Domain.BucketFieldExclusion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BucketId", "FieldId")
                        .IsUnique();

                    b.ToTable("BucketFieldExclusions");
                });

            modelBuilder.Entity("PluralHost.Api.Domain.CustomField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PluralHost.Api.Domain.JournalEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PluralHost.Api.Domain.MemberRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PluralHost.Api.Domain.PrivacyBucket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PluralHost.Api.Domain.MemberRelationship", b =>
                {
                    b.HasOne("PluralHost.Api.Domain.Member", "FromMember")
                        .WithMany()
                        .HasForeignKey("FromMemberId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PluralHost.Api.Domain.Member", "ToMember")
                        .WithMany()
